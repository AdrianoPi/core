...
inline __neuron_s* fetch_current_state(void);
...
extern __neuron_s* fetch_current_state(void);
...
void snn_module_init(void){// Init the neuron memory here (memory manager is up and running) rather than in ProcessEvent of INIT
